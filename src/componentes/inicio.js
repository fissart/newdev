  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <mesh scale={sizew.x < 615 ? size * .5 : size * 1}>
        ...
        <Html className="content" style={{ background: 'brown' }} occlude="blending" distanceFactor={1.8} rotation-y={-3.14} rotation-x={-3.14} rotation-z={-3.1416} position={[0, 0, 3]} transform>
          <HeroPage />
        </Html>
        <Html className="content" style={{ background: 'blue' }} occlude="blending" distanceFactor={1.8} rotation-y={3.14 / 2} rotation-x={-3.14} rotation-z={-3.1416} position={[3, 0, 0]} transform>
          <p>width is : {sizew.x}</p>
          <p>height is : {sizew.y}</p>
          <HeroPage />
        </Html>
...
export default function Home() {
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, height: '100vh', width: '100%', textAlign: 'center', margin: 'auto', display: 'block' }}>
