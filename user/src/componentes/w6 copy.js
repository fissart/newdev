...
const NoPage = () => {
  ...
  return <div className="contenedor">
    ...
    {wwwww ?
      < div style={{ backgroundColor: 'orange', width: '100%' }} key={wwwww._id}>
        {edit == "false" ?
          <>
            <button onClick={() => { setEdit("true") }}>Editar</button>
            <div style={{ padding: '.1cm', textAlign: 'center' }}>{user.dni}</div>
            <div style={{ padding: '.1cm', textAlign: 'center' }}>{unity.title}</div>
            <div style={{ padding: '.1cm', textAlign: 'center' }}>{curso.title}</div>
            <div style={{ padding: '.1cm', textAlign: 'center' }}>{curso.mencion}
              {curso.ciclo}..
              {curso.requisito}..
              {curso.year}..
              {curso.codigo}..
            ...
            <div style={{ backgroundColor: 'white' }} ref={contentRef}>
